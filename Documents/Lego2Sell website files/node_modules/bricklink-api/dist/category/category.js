...
class Category {
  ...
  static get(categoryId) {
    ...
    return new _request.BricklinkRequest(method, uri, null, data => new Category(data));
  }
  /**
  ...
  static all() {
    let method = _request.BricklinkRequest.GET;
    let uri = `/categories`;
    return new _request.BricklinkRequest(method, uri, null, data => data.map(d => new Category(d)));
  }
