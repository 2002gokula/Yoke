...
class Color {
  ...
  static get(colorId) {
    ...
    return new _request.BricklinkRequest(method, uri, null, data => new Color(data));
  }
  /**
  ...
  static all() {
    let method = _request.BricklinkRequest.GET;
    let uri = `/colors`;
    return new _request.BricklinkRequest(method, uri, null, data => data.map(d => new Color(d)));
  }
